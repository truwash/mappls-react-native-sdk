...
| ---- | ---- |    
| [v2.0.1](../v2.0.1/README.md) | - Map SDK v2.0.3 <br/> - Place Search Widget v2.0.1 <br/> - Mappls Polyline v1.0.0 <br/> - Direction Widget v2.0.1 <br/> - Nearby UI Widget v2.0.0 <br/> - GeoFence Widget v2.0.1 |
